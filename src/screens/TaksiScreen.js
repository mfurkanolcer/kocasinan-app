...
import taksiData from '../taksi.json';
...
const TaksiScreen = () => {
  ...
  const [options, setOptions] = useState(taksiData)
...
<View className={"flex-1 space-y-3 pb-2 bg-[#004799] rounded-[60px]"}>
        ...
        <View className="mx-8 mb-1">
          ...
          <View className=" pt-3  mx-auto ">
            <Text className=" text-xl text-white  font-small text-md  mt-2 text-center">Taksiler</Text>
            <Text className="  text-slate-200  font-light text-sm  mt-2 text-center">En yakın taksi için sağ üstteki {"\n"} konum butonuna tıklayınız</Text>
          </View>
        </View>
        </View>
              ...
              return (
                <View style={styles.card}>
                  <View style={styles.cardContent}>
                    <Image style={[styles.image, styles.imageContent]} source={require('../../assets/images/taksi.png')} />
                    <View className="pl-2">
                    ...
                    <View className="pl-1 " >
                      <TouchableOpacity style={styles.gpsIcon} onPress={() => { Linking.openURL(`tel:${item.phone}`) }}>
